...
describe("registerTools", () => {
  ...
  it("registers all expected tool names", () => {
    ...
    // Creation tools
    expect(names).toContain("layer_createLayer");
    expect(names).toContain("layer_deleteLayer");
    expect(names).toContain("bone_addBone");
    expect(names).toContain("bone_deleteBone");
    expect(names).toContain("bone_setRestPose");
