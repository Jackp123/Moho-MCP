...
local function loadModules(baseDir)
	...
	-- Load tool handlers
	local toolModules = {
		{ name = "moho_mcp.tools.document",  methods = { "document.getInfo", "document.getLayers", "document.setFrame", "document.screenshot", "document.save", "document.setCamera", "document.undo", "document.redo" } },
